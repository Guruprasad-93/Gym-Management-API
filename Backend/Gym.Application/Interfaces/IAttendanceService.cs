...
public interface IAttendanceService
{
    ...
    Task UpdateSettingsAsync(UpdateAttendanceSettingsDto dto, CancellationToken cancellationToken = default);
    Task<int> RunAutoCheckoutProcessingAsync(CancellationToken cancellationToken = default);
